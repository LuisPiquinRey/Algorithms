...
public class StringExercises {
    public static void main(String[] args){
        ...
        Arrays.toString(tableLPS("Canakfbckbakbeskfbacaafej"));
    ...
    //Given a string S, the task is to find the length of the longest substring between any pair of occurrences of same characters
    /*
